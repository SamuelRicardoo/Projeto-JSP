								...
								<div class="main-menu-content">
									<ul>
										<li class="more-details"><a href="user-profile.html"><i
											...
											href="<%= request.getContextPath() %>/ServeletLogin?acao=logout"><i
							...
							<ul class="pcoded-item pcoded-left-item">
								...
								<li class="pcoded-hasmenu"><a href="javascript:void(0)"
									...
									<ul class="pcoded-submenu">
							 		<c:if test="${perfil == 'Admin'}"> <!-- Para verificar se é  Admin para entrar na guia Usuario -->
										<li class=" ">
										<a href="<%= request.getContextPath()%>/ServeletUsuarioController?acao=listarUser" class="waves-effect waves-dark"> <span
